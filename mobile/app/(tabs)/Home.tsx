...
import { Button, TitledContainer } from "../../src/components/index";
...
export const Home = () => {
  ...
  const renderProfileImage = () => (
    <View style={styles.containerImage}>
      <Image style={{ width: 140, height: 140 }} resizeMode="cover" source={require("../../src/assets/ProfilePicturePNG.png")} />
    </View>
  );
  ...
  return (
    <TitledContainer disableArrow>
      <ScrollView style={{ flex: 1 }}>
        <ImageBackground style={{ flex: 1 }} source={require("../../src/assets/BackgroundPNG.png")}>
          <View style={styles.container}>
            {renderProfileImage()}
            {renderSobrietyTimer()}

            <View style={styles.buttonsContainer}>
              {renderActionButton(<Hand color="white" size={20} />, "Promessa", () => router.push("Commitment"))}
              {renderActionButton(<Clock color="white" size={20} />, "Meditar", () => router.push("Meditate"))}
